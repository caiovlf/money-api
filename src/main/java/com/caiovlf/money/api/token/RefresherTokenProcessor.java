package com.caiovlf.money.api.token;
...
@ControllerAdvice
public class RefresherTokenProcessor implements ResponseBodyAdvice<OAuth2AccessToken>{
	...
	public OAuth2AccessToken beforeBodyWrite(OAuth2AccessToken body, MethodParameter returnType, MediaType selectedContentType,
		...
		//Cast para conseguir utilizar o setRefreshToken
